...
# chile2010 _output
simdir = joinpath("../run090312UTC_1kmWRF_HIMSST/_output")
...
# load water surface
amrall = loadstorm(simdir, timestart:timeend
...
# plot
plts = plotsamr(amrall; c=:jet, clims=(0,50),
...
plts = map(p->plotscoastline!(p, topo; lc=:white), plts)
