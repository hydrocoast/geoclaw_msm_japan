...
# chile2010 _output
simdir = joinpath("../CalSet/testrun_haishen_Wa10/_output")
...
using Dates: Dates
timeorigin = Dates.DateTime(2020,9,4,0,0)
...
topo = loadtopo("../CalSet/topo/depth_0810-02_zone01_lonlat.asc")
...
# track
plts = map((p,t) -> plotstrack!(p, track, 41:timestart+t-1; lc=:green, lw=3), plts, 1:amrall.nstep)
