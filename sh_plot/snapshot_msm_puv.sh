...
## filenames
#grd="../ncfile_puv/20211111/MSM2021111100S_psea_0.nc"
...
hoffset=${fbase##*_}
hoffset=${hoffset//.nc/}
ymdhtitle="${ymdh:0:4}-${ymdh:4:2}-${ymdh:6:2} ${ymdh:8:2}:00 UTC + $hoffset hours"
...
if [ ! -d $ymdh ]; then mkdir $ymdh; fi
gmt psconvert $outps -A+m0.5 -Tg
mv ${outps//.ps/.png} $ymdh/
gmt psconvert $outps -A+m0.5 -Tf
mv ${outps//.ps/.pdf} $ymdh/
