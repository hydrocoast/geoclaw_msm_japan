...
% 2021/5/28, temporally made but this file will be removed
% ===================================================================


% function [data,time] = func_read_fd_swt_un(filename,info_region,nt)
function data = func_read_fd_swt_un(filename,info_region,nt)
% open file
