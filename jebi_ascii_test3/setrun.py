...
#------------------------------
    ...
    regions.append([1, 2, days2seconds(2), clawdata.tfinal, 130.0, 140.0, 25.0, 40.0])
    regions.append([1, 3, days2seconds(2), clawdata.tfinal, 132.0, 137.0, 30.0, 35.0])
...
#-------------------
    ...
    refine_data.speed_tolerance = [0.50, 1.00]
